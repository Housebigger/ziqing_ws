...
def generate_launch_description():
    package_name = 'bigma7ax0514_moveit_config0515'

    robot_name_in_model = 'bigma7ax0514'

    pkg_share = FindPackageShare(package=package_name).find(package_name) 
    urdf_model_path = os.path.join(pkg_share, f'config/bigma7ax0514_gazebo.urdf.xacro')
    gazebo_world_path = os.path.join(pkg_share, f'config/tubewhole0515.world')
    spawn_x_val = '2.0'
    spawn_y_val = '2.0'
    spawn_z_val = '0.3'
    spawn_var_val = '0.00'
