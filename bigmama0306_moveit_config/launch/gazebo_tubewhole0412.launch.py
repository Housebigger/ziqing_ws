...
def generate_launch_description():
    package_name = 'bigmama0306_moveit_config'

    robot_name_in_model = 'bigmama0306'

    pkg_share = FindPackageShare(package=package_name).find(package_name) 
    urdf_model_path = os.path.join(pkg_share, f'config/bigmama0306_gazebo.urdf.xacro')
    gazebo_world_path = os.path.join(pkg_share, f'config/tubewhole0412.world')
    spawn_x_val = '0.0'
    spawn_y_val = '0.0'
    spawn_z_val = '3.00'
    spawn_var_val = '3.1416'
    ...
    # 下面这个启动gazebo的方式来自鱼香ROS。人们都说用这个问题少一些
